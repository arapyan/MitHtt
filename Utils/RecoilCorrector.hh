...
class RecoilCorrector
{
 ...
 public:
  RecoilCorrector(string iNameZDat = "$CMSSW_BASE/src/MitHtt/Utils/recoilfitZDat.root",string iNameZMC  = "$CMSSW_BASE/src/MitHtt/Utils/recoilfitZMC.root", int iSeed=0xDEADBEEF);
 ...
 protected:
  int readRecoil(std::vector<double> &iSumEt,
		       ...
		       std::string iFName = "$CMSSW_BASE/src/MitHtt/Utils/recoilfit-new.root"); 
