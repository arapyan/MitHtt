...
TFile *fZMCFileNVtx = new TFile("/build/pharris/Recoil/ztt_select_recoil_novtx.root");
TTree *fZMCTreeNVtx = (TTree*) fZMCFileNVtx->FindObjectAny("Events");

TFile *fZMCFile = new TFile("/build/pharris/Recoil/ztt_select_recoil.root");
TTree *fZMCTree = (TTree*) fZMCFile->FindObjectAny("Events");

TFile *fWWMCFile = new TFile("/build/pharris/Recoil/ww_select_recoil.root");
TTree *fWWMCTree = (TTree*) fWWMCFile->FindObjectAny("Events");

TFile *fQCDMCFile = new TFile("/build/pharris/Recoil/qcd_select_recoil.root");
TTree *fQCDMCTree = (TTree*) fQCDMCFile->FindObjectAny("Events");

TFile *fTTMCFile = new TFile("/build/pharris/Recoil/ttbar_select_recoil.root");
TTree *fTTMCTree = (TTree*) fTTMCFile->FindObjectAny("Events");

TFile *fDataFile = new TFile("/build/pharris/Recoil/data_select_recoil.root");
...
const int readRecoil(std::vector<double> &iSumEt,
		     ...
		     std::string iFName = "/build/pharris/Recoil/recoilfit.root") { 
...
void correctZtt(std::string iNameZDat = "/build/pharris/Recoil/recoilfitZDat.root",std::string iNameZMC = "/build/pharris/Recoil/recoilfitZMC.root") { 
  Prep();
  double lLumi = 190;
