...
#include "MitHtt/Ntupler/interface/LikelihoodFunctions.h"
#include "MitHtt/Ntupler/interface/NSVfitStandaloneLikelihood.h"
...
NSVfitStandaloneLikelihood::transform(double* xPrime, const double* x) const
{
  ...
  */
  ...
  xPrime[ kMTauTau ] = fittedDiTauSystem.M();
