...
void plotETauMSSM(std::string iVar="m_vis",int iCat = 0,int makecard=0,TFile *outfile=0,std::string iCut="(pt_1 > 45 && pt_2 > 45 && iso_1 > 0.5 && iso_2 > 0.5 && jpt_1 > 30.0 && abs(jeta_1) < 3.0 ",float iLumi=12000) { 
  SetStyle();  
  ...
  lTree[3]  = load(lName+"zee_select.root");  fString[3] = "Z#rightarrow#tau#tau fakes";     fColor[3] = 603;  fCard[3]="ZL"; ptrew[3]=1;
  ...
  fWeights[0]="(pt_1>24&&pt_2>20 && abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2 && iso_1<0.5 && passAntiEleNewWPMVA3_2>1.5 && ((pvz+130./tan(2*TMath::ATan(exp(-1.0*eta_2)))) > 0.5 || (pvz+130./tan(2*TMath::ATan(exp(-1.0*eta_2))))<-1.5))*weight*decaymodeweight*emblid*(genmatch==3)";
  fWeights[3]="(pt_1>24&&pt_2>20 && abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2 && iso_1<0.5 && passAntiEleNewWPMVA3_2>1.5 && ((pvz+130./tan(2*TMath::ATan(exp(-1.0*eta_2)))) > 0.5 || (pvz+130./tan(2*TMath::ATan(exp(-1.0*eta_2))))<-1.5))*weight*decaymodeweight*(genmatch==3)";
  //fWeights[0]="(pt_1>24&&pt_2>20 && abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2 && iso_1<0.5)*weight";
  //fWeights[3]="(pt_1>24&&pt_2>20 && abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2)*weight*(abs(genlid_1)>=15 && abs(genlid_2)>=15)";
  ...
  if(iCat==9)
    ...
    fWeights[1]  += "*1.0";
  if(makecard)
    fWeights[3]  += "*1.01*zeefrate*(abs(genlid_1)<15 && abs(genlid_2)<15 && genmatch==1)";
  else
    fWeights[3]  += "*1.01*zeefrate*(abs(genlid_1)<15 && abs(genlid_2)<15)";
