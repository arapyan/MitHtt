...
void rescale(TH1F* hin, unsigned int idx)
{
  ...
  switch(idx){
   case 1: //ZTT 
std::cout<<"ZTT scaling by 0.974975"<<std::endl;hin->Scale(0.974975);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 2: // QCD
std::cout<<"QCD scaling by 1.047940"<<std::endl;hin->Scale(1.047940);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 3: // W
std::cout<<"W scaling by 1.073920"<<std::endl;hin->Scale(1.073920);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 4: // ZJ
std::cout<<"ZJ scaling by 1.009307"<<std::endl;hin->Scale(1.009307);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 5: // ZL
std::cout<<"ZL scaling by 0.931226"<<std::endl;hin->Scale(0.931226);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 6: // TT
std::cout<<"TT scaling by 0.913377"<<std::endl;hin->Scale(0.913377);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 7: // VV
std::cout<<"VV scaling by 0.100127"<<std::endl;hin->Scale(0.100127);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 8: // ggH
std::cout<<"SM120 scaling by 0.995410"<<std::endl;hin->Scale(0.995410);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
  case 9: // bbH
std::cout<<"VBF120 scaling by 0.995410"<<std::endl;hin->Scale(0.995410);std::cout<<hin->GetName()<<"Scaled Integral is "<<hin->Integral()<< std::endl; break; 
...
etauAfterFit_vbf(bool scaled = true)
{
  ...
  TH1F* ggH   =  refill((TH1F*)exampleFile->Get("eleTau_SM2/SM120" ))           ; InitSignal(ggH); ggH ->Scale(10*1);
  TH1F* qqH   =  refill((TH1F*)exampleFile->Get("eleTau_SM2/VBF120"))           ; InitSignal(qqH); qqH ->Scale(10*1);
