/**
   \class   plot_acc_b plot_acc_b.C "MitHtt/macros/plot_acc_b.c"

   \brief   macro to create the acceptance plots for the B-Tag Category as descriobed in AN-11-153

   macro to creat the acceptance plots as function of mA/mH after the B-Tag Category as desribed in 
