...
void bbtt_mt(std::string var,int nbins, double xmin, double xmax,std::string xtitle, std::string ytitle)
{
  SetStyle(); gStyle->SetLineStyleString(11,"20 10");
  TH1::SetDefaultSumw2(1);

  std::string dir = "/data/blue/Bacon/029a/mutau/ntuples/mhhvar/";
  double sigscale = 10;
  double sigscale1 = 10000; 
  ...
  std::string objcut = "(abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2 && pt_1>20 && pt_2>30 && byCombinedIsolationDeltaBetaCorrRaw3Hits_2<1.5 && iso_1<0.1)";
  std::string objcutloose = "(abs(eta_1) <2.1 && abs(eta_2)<2.3 && abs(dZ_2)<0.2 && pt_1>20 && pt_2>30 && byCombinedIsolationDeltaBetaCorrRaw3Hits_2<1.5 && iso_1<0.1)";
   std::string jetcut = objcut+"*(mtMVA_1<30 && jpt_1>30 && jpt_2>30 && jcsv_1>0.244 && jcsv_2>0.244)";
   std::string jetcutloose = objcutloose+"*(mtMVA_1<30 && jpt_1>30 && jpt_2>30 && jcsv_1>0.244 && jcsv_2>0.244) ";
  ...
  std::string zllcut = jetcut+"*weight*(decaymodeweight/1.972e09)*(abs(genlid_1)<15 && abs(genlid_2)<15 && genmatch==1)*(q_1*q_2<0)*"+lumi.str();
  ...
  TTree *smhhtree = load(dir+"s12-hh125-bbtt-mt-8tev_select.root");
