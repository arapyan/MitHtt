...
plotdir=/scratch/dkralph/htt/selections/test
...
#root -b -q -l selectEmu.C+\(\"emu.conf\",\"$ntupledir\",865,0\)  # central value
#root -b -q -l plotEmu.C+\(\"emu.conf\",\"$ntupledir/ntuples\",\"$plotdir\",\"png\",865\) 2>&1 | grep -v 'Info in <TCanvas::'
#
